...
import ObrasSociales from "./../../serviciomedico/utilssm/ObrasSociales"
import Planes from "./../../serviciomedico/utilssm/Planes";
...
const PacienteData = ({ data, onChangeData }) => {
	...
	return(
		<div className="max-w-4xl w-full">
			<div className={`mt-4 mb-2 rounded-md p-2 text-white ${parseInt(data.idpaciente, 10) !== 0 ? "bg-blue-400" : "bg-green-400"}`}>{ parseInt(data.id, 10) !== 0 ? "Modificar Paciente" : "Agregar nuevo Paciente" }</div>
			<form className="mt-2">
